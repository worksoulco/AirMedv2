...
DROP TABLE IF EXISTS provider_codes CASCADE;
DROP TABLE IF EXISTS provider_details CASCADE;
...
-- Create patient_providers table with proper relationships
...
CREATE INDEX idx_provider_details_id ON provider_details(id);
CREATE INDEX idx_provider_codes_provider_id ON provider_codes(provider_id);
...
CREATE INDEX idx_patient_providers_code_id ON patient_providers(code_id);
...
-- Handle connection request function
